    ...
    const DSMC_CASES = {
        ...
        cases: [
            {
                case_id: "five_species_heat_bath",
                ...
                species: [
                    ...
                    },
                    {
                        ...
                        mass_kg: 31.998 * AMU,
                        diameter_m: 4.07e-10,
                        viscosity_temperature_exponent: 0.77,
                        vss_alpha: 1.4,
                        rotational_degrees_of_freedom: 2,
                        vibrational_characteristic_temperatures_k: [2256.0],
                        vibrational_dissociation_temperatures_k: [59500.0],
                        vibrational_z_ref: [17900.0],
                        vibrational_z_ref_temperature_k: [2256.0],
                    },
                    {
                        name: "NO",
                        mass_kg: 30.006 * AMU,
                        diameter_m: 4.20e-10,
                        viscosity_temperature_exponent: 0.79,
                        vss_alpha: 1.0,
                        rotational_degrees_of_freedom: 2,
                        vibrational_characteristic_temperatures_k: [2719.0],
                        vibrational_dissociation_temperatures_k: [75500.0],
                        vibrational_z_ref: [1400.0],
                        vibrational_z_ref_temperature_k: [2719.0],
                    },
                    {
                        name: "N",
                        mass_kg: 14.007 * AMU,
                        diameter_m: 3.00e-10,
                        viscosity_temperature_exponent: 0.8,
                        vss_alpha: 1.0,
            ...
            {
                case_id: "seven_species_lab_mix",
                collision_model: ACTIVE_COLLISION_MODEL_LABEL,
                partner_selection: "no_time_counter",
                rotational_relaxation_collision_number: 1.0,
                vibrational_relaxation_collision_number: 1.0,
                electronic_relaxation_collision_number: 1.0,
                reference_temperature_k: 298.0,
                species: [
                    {
                        name: "H2",
                        mass_kg: 2.01588 * AMU,
                        ...
                        vss_alpha: 1.2,
                        rotational_degrees_of_freedom: 2,
                        vibrational_characteristic_temperatures_k: [6100.0],
                        vibrational_dissociation_temperatures_k: [42000.0],
                        vibrational_z_ref: [600.0],
                        vibrational_z_ref_temperature_k: [6100.0],
                    },
                    {
                        name: "N2",
                        mass_kg: 28.0134 * AMU,
                    ...
                    },
                    {
                        name: "CO2",
                        mass_kg: 44.01 * AMU,
                        diameter_m: 3.996e-10,
                        viscosity_temperature_exponent: 0.76,
                        vss_alpha: 1.0,
                        rotational_degrees_of_freedom: 3,
                        vibrational_characteristic_temperatures_k: [959.0, 3380.0],
                        vibrational_dissociation_temperatures_k: [53000.0, 53000.0],
                        vibrational_z_ref: [30000.0, 35000.0],
                        vibrational_z_ref_temperature_k: [959.0, 3380.0],
                    },
                    {
                        name: "CH4",
                        mass_kg: 16.04 * AMU,
                        ...
                        viscosity_temperature_exponent: 0.77,
                        vss_alpha: 1.12,
                        rotational_degrees_of_freedom: 5,
                        vibrational_characteristic_temperatures_k: [1306.0],
                        vibrational_dissociation_temperatures_k: [104000.0],
                        vibrational_z_ref: [9000.0],
                        vibrational_z_ref_temperature_k: [1306.0],
                    },
                    {
                        name: "NO",
                        mass_kg: 30.006 * AMU,
                    ...
                    },
                    {
                        name: "He",
                        mass_kg: 4.0026 * AMU,
                        diameter_m: 2.576e-10,
                        viscosity_temperature_exponent: 0.67,
                        vss_alpha: 1.0,
                        rotational_degrees_of_freedom: 0,
                        vibrational_characteristic_temperatures_k: [],
                        vibrational_dissociation_temperatures_k: [],
            ...
            },
            {
                ...
                species: [
                    ...
                    },
                    {
                        ...
                        mass_kg: 28.01 * AMU,
                        diameter_m: 3.65e-10,
                        viscosity_temperature_exponent: 0.78,
                        vss_alpha: 1.08,
                        rotational_degrees_of_freedom: 2,
                        vibrational_characteristic_temperatures_k: [3080.0],
                        vibrational_dissociation_temperatures_k: [86000.0],
                        vibrational_z_ref: [1200.0],
                        vibrational_z_ref_temperature_k: [3080.0],
                    },
                    {
                        name: "N",
                        mass_kg: 14.007 * AMU,
                    ...
                    },
                    {
                        ...
                        mass_kg: 20.1797 * AMU,
                        diameter_m: 2.75e-10,
                        viscosity_temperature_exponent: 0.69,
                        vss_alpha: 1.0,
                        rotational_degrees_of_freedom: 0,
                        vibrational_characteristic_temperatures_k: [],
                        vibrational_dissociation_temperatures_k: [],
    ...
    function loadHeatBathCase(caseId = "five_species_heat_bath") {
